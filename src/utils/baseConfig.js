...
const DEFAULT_SITE_CONFIG = {
  siteName: 'Nebula Cloud',
  siteDescription: 'NBCI',
  copyright: `© ${new Date().getFullYear()} NB THEME. All Rights Reserved.`,
...
const DEFAULT_CUSTOMER_SERVICE_CONFIG = {
  ...
  // 客服系统HTML代码
  customHtml: '<script type="text/javascript">window.$crisp=[];window.CRISP_WEBSITE_ID="4994ee60-c935-453e-9ecc-73298f98fb6c";(function(){d=document;s=d.createElement("script");s.src="https://client.crisp.chat/l.js";s.async=1;d.getElementsByTagName("head")[0].appendChild(s);})();</script>',
